...

{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            filaNomes.Enqueue("Suelly");

            Console.WriteLine("Impressão dos filasNomes");
            Console.WriteLine($" 1°) {filaNomes.Dequeue()}");

            foreach (string nome in filaNomes)
            {

                Console.WriteLine($" - {filaNomes}");
            }
            ...
            Console.WriteLine("Impressão dos stacksNomes");
