    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            foreach (var item in diaDaSemanaSemEnum)
            {
                ...
                //else if (item == 1) Console.WriteLine("Terça");
                //else if (item == 1) Console.WriteLine("Quarta");
                //else if (item == 1) Console.WriteLine("Quinta");
                //else if (item == 1) Console.WriteLine("Sexta");
                //else if (item == 1) Console.WriteLine("Sabado");
            ...
            List<DiaDaSemana> diaDaSemanaComEnum = new List<DiaDaSemana>() { DiaDaSemana.Domingo, DiaDaSemana.Segunda,
            ...
            foreach (var item in diaDaSemanaComEnum)
            {
                ...
                //{ (int) item} - faz um Cast, conversão, do texto para o número equivalente
